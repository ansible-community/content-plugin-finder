...
try:
    ...
    def _pkg_version(_name: str) -> str:
...
def get_scanner_version():
    ...
    try:
        version = _pkg_version("ansible-content-capture")
    except Exception:
        pass
    if version != "":
        return version
    # Vendored under content-plugin-finder
    try:
        version = _pkg_version("content-plugin-finder")
    except Exception:
        pass
    if version != "":
        return version
